...
public class MainActivity extends Activity implements View.OnClickListener
{
	...
	private String s="0000000000";//检测到的nfc卡号
    ...
    public void onClick(View view)//主页面布局
    {
        ...
        switch(id)
        {
        	case R.id.login:
                ...
                fc.reaction(ok,ok2,MainActivity.this);
                if(ok&&ok2)
                {
                   log_after(name);
                }
    ...
    private void ap_login()//注册界面
    {
        ...
        ap_register_btn.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View v)
            {
                ...
                boolean ok=val[0];
                function fc=new function();
                fc.sing_reaction(ok,MainActivity.this);
                if(ok==false)//可以创建
                {   
...
//    	main_recall();
    ...
    public void log_after(final String s)//将用户名字一起导入
    {
         ...
         SQLiteDatabase db = helper.getWritableDatabase();
         values.put(Usertime.USER_NAME, s);
    ...
    public void nfc_c(final String ss)
    {
//    	//注册NFC卡号
//    	final String nfc1="0056B3F178";
//    	final String nfc2="00C68DD778";
...
//    	boolean isOpen = false;
    	...
    	//requestWindowFeature(Window.FEATURE_NO_TITLE);
		setContentView(R.layout.nfc_c);
		
		button1=(Button)findViewById(R.id.btn_nfc_find2);
		button2=(Button)findViewById(R.id.btn_nfc_return2);
		textView1=(TextView)findViewById(R.id.txt_nfc_result2);
		light(2);
		//isOpen = false;
		...
		button1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
		        ...
		        SQLiteDatabase db = helper.getWritableDatabase();
				 boolean ok=is_in_nfc(ss,id,db);
				 if (ok==false){
			  	 values.put(Nfc.USER_NAME,ss);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if(resultCode == RESULT_OK)
        {
            ...
            function fc=new function();
            fc.reaction(ok,true,MainActivity.this);
            if(ok)
            {
            	log_after(name);
            }
        ...
        {
        	 function fc=new function();
             fc.scan_fail(MainActivity.this);
        }
    }
